package net.lordoflizardz.onemillionbananas.command;
...
public class ReturnHomeCommand {
    ...
    private int returnHome(CommandSourceStack source) throws CommandSyntaxException {
        ...
        boolean hasHomepos = player.getPersistentData().getIntArray(OneMillionBananas.MOD_ID + "homepos").length != 0;

        if(hasHomepos) {
            int[] playerPos = player.getPersistentData().getIntArray(OneMillionBananas.MOD_ID + "homepos");
