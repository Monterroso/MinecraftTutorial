package net.lordoflizardz.onemillionbananas.recipe;
...
public class CobaltBlasterRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Serializer implements RecipeSerializer<CobaltBlasterRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(OneMillionBananas.MOD_ID,"cobalt_blasting");
