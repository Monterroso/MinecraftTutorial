...
import net.lordoflizardz.onemillionbananas.block.entity.CobaltBlasterBlockEntity;
import net.lordoflizardz.onemillionbananas.screen.slot.ModFuelSlot;
import net.lordoflizardz.onemillionbananas.screen.slot.ModResultSlot;
...
public class CobaltBlasterMenu extends AbstractContainerMenu {
    ...
    public int getScaledFuelProgress() {
        int fuelProgress = data.get(2);
        int maxFuelProgress = data.get(3);
